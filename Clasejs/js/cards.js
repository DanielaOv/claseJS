...
var arrayProductos = [];
   do { var comprobacion = prompt('ingrese un nombre del prodcuto o fin de terminar de agregar');
    if (comprobacion === "fin" || comprobacion == "FIN" || comprobacion === "Fin"){
        break;
    }else{
        nombreP= comprobacion;
        var precioP = prompt ('Ingrese el precio del prodcuto');
        var detalleP = prompt ('Ingrese el detalle del producto');
        var cantidadP = prompt ('Ingrese la cantidad de comprada del producto');
        arrayProductos.push(new Prodcuto(nombreP, precioP, detalleP, cantidadP));
    }
}
